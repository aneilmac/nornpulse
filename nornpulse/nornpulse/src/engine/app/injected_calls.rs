...
// extern "cdecl" fn add_initalisation_function(Box<dyn Fn(&mut App)> f) -> i32 {
//     App::add_initalisation_function(f)
// }

// extern "thiscall" fn auto_kill_agents_on_error(app: &App) -> bool {
//     app.auto_kill_agents_on_error()
// }
...
//     app.call_initialization_functions()
// }
...
// extern "thiscall" fn check_all_free_disk_space(app: &mut App, i1: i32, i2: i32) -> bool {
//     app.check_all_free_disk_space(i1, i2)
// }
...
// extern "thiscall" fn check_for_mutex(app: &App) -> bool {
//     app.check_for_mutex()
// }

// extern "thiscall" fn check_free_disk_space(app: &mut App, path: CppString, i1: i32) -> bool {
...
// extern "thiscall" fn do_i_need_to_get_password(app: &mut App) -> bool {
// }
...
// extern "thiscall" fn get_creature_pickup_status(app: &mut App) -> int {
// }
...
// extern "cdecl" fn get_initialisation_functions(var_name: CppString) -> vector<fn (&mut App)> {
// }
...
// extern "thiscall" fn get_line_plane(app: &App) -> int {
// }

// extern "thiscall" fn get_maximum_distance_before_port_line_snaps(app: &App) -> int {
// }

// extern "thiscall" fn get_maximum_distance_before_port_line_warns(app: &App) -> float {
// }
...
// extern "thiscall" fn get_password(app: &App) -> String {
// }
...
// extern "thiscall" fn get_system_tick(app: &App) -> bool {
// }
...
// extern "thiscall" fn which_creature_permission_to_highlight(app: &App) -> int {
// }

// extern "thiscall" fn get_world(app: &App) -> Box<World> {
// }
...
// extern "thiscall" fn init(app: &mut App) -> bool {
// }
...
// extern "thiscall" fn play_all_sounds_at_maximum_level(app: &App, nickname: CppString) {
// }

// extern "thiscall" fn process_command_line(app: &mut App, args: CppString) {
// }
...
// extern "thiscall" fn set_password(app: &mut App, name: CppString) {
// }
...
// extern "thiscall" fn set_whether_we_should_highlight_agents_known_to_creature(app: &mut App, flag: bool) {
// }
...
// extern "thiscall" fn set_should_skeletons_animate_double_speed(app: &App, flag: bool) {
// }
...
// extern "thiscall" fn window_has_resized(app: &App) -> bool {
// }
